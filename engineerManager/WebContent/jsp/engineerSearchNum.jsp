					...
					<div class="col-lg-12">
						<div class="panel panel-default" style="width: 1000px;">
							<div class="panel-body" style="padding-left: 10px;">
								...
								String sqlQuery1 = "SELECT * FROM engineermanager.engineer WHERE en_num='"+enNum+"'";

							  try{
								  Class.forName("com.mysql.jdbc.Driver");
									Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/engineermanager","root","w1010");
									Statement sql = con.createStatement();									 
									ResultSet rs = sql.executeQuery(sqlQuery1);
								%>						
								<table>
									<tr>
										<th>编号</th>
									...
									if(rs.next()){
									  ...
									  out.print("</tr>");
										...
										out.print("<script language='JavaScript'>alert('请输入正确编号');window.location.href='engineer_search_num.jsp'</script>");
									}
									con.close();
