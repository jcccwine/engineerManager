					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="tabnav">
									<span><a href="engineer_search_num.jsp" style="color: black;text-decoration: none;">编号</a></span>
									<span class="fou">姓名<label></label></span>
								</div>
								<div>
									<form action="engineerDeleteName.jsp" method="post" autocomplete="off" >
										<div class="form-group">
											<input type="text" name="username" placeholder="请输入工程师姓名" class="form-control" style="margin-left: 0px;">
											<input type="submit" value="删除" class="btn btn-default" style="margin-top: 20px;width: 80px;">
										</div>
									</form>
								</div>
							</div>
