					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="col-gl-6">
									<form role="form" action="engineer_add.jsp" method="post" autocomplete="off">
										<div class="form-group">
											<input type="text" name="num" placeholder="工程师编号" class="form-control">
											<input type="text" name="name" placeholder="工程师姓名" class="form-control">
											<input type="text" name="sex" placeholder="性别" class="form-control">
											<input type="text" name="birth" placeholder="生日" class="form-control">
											<input type="text" name="place" placeholder="籍贯" class="form-control">
											<input type="text" name="educate" placeholder="学历" class="form-control">
											<input type="text" name="address" placeholder="地址" class="form-control">
											<input type="text" name="tel" placeholder="电话" class="form-control">
											<input type="text" name="workage" placeholder="工龄" class="form-control">
											<input type="text" name="salary" placeholder="基本薪水" class="form-control">
